...
<IfModule mod_rewrite.c>
  RewriteEngine On
  RewriteBase ${base}/
  # Absolute web paths only — relative [R] redirects on Aruba become /web/htdocs/.../home/...
  RewriteRule ^$ ${base}/index.php [R=302,L]
  RewriteRule ^menu\\.html$ ${base}/index.php [R=302,L]
  RewriteRule ^index\\.html$ ${base}/index.php [R=302,L]
  RewriteRule ^en\\.html$ ${base}/en.php [R=302,L]
  RewriteRule ^en$ ${base}/en.php [R=302,L]
</IfModule>
`;
}
